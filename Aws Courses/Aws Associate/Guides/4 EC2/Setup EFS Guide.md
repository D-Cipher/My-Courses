...
sudo su
```
3. Check to make sure that appache is installed by making sure /var/www/html exists. This was a prerequisite.
```
cd /var/www/html
```
...
```
3. Go to your first instance: ec2-user@34.230.8.154 and paste in the above command but change "efs" to /var/www/html Note: if it hangs for more than a minute then there may be an issue with your security group or network acl.
```
